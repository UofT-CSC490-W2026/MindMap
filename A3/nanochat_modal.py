...
RUN_TYPE = "baseline"  # "baseline", "gqa4", "swiglu", or "both" (gqa4 + swiglu)
KV_RATIO = 1
...
def main(run_type: str) -> None:
    ...
    if run_type == "baseline":
        ...
        stage_pretrain.remote(
            depth=DEPTH,
            device_batch_size=DEVICE_BATCH_SIZE,
            wandb_run="pico_d4_swiglu",
            model_tag="pico_d4_swiglu",
            kv_ratio=1,
            mlp_type="swiglu",
        )
    elif run_type == "both":
        stage_pretrain.remote(
            depth=DEPTH,
            device_batch_size=DEVICE_BATCH_SIZE,
            wandb_run="pico_d10_gqa4_swiglu",
            model_tag="pico_d10_gqa4_swiglu",
            kv_ratio=4,
            mlp_type="swiglu",
        )
    else:
