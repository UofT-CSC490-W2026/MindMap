...
parser.add_argument(
    ...
    type=int,
    default=1,
    help="query_heads / kv_heads. 1 = regular MHA, 2 = half as many KV heads, 4 = quarter as many KV heads"
)
...
parser.add_argument(
    ...
    help="MLP type: relu2 (default) or swiglu"
)
...
def build_model_meta(depth):
    ...
    kv_ratio = max(1, args.kv_ratio)
    num_kv_heads = max(1, num_heads // kv_ratio)

    assert num_heads % num_kv_heads == 0, (
        f"Invalid GQA setting: n_head={num_heads}, n_kv_head={num_kv_heads}"
    )
