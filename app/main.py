...
from app.config import app, snowflake_secret, semantic_scholar_secret
...
@app.function(image=api_image, secrets=[snowflake_secret, semantic_scholar_secret], timeout=60 * 20)
@modal.asgi_app()
def fastapi_app():
