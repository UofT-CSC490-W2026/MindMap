...
from app.utils.modal_config import app_ml, image_citation_aware, secret_mindmap
...
@app_ml.function(image=image_citation_aware, secrets=[secret_mindmap], timeout=60 * 30)
