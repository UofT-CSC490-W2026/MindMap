...
from app.utils.modal_config import app_ml, image_embedding, secret_snowflake
...
@app_ml.function(image=image_embedding, secrets=[secret_snowflake], timeout=60 * 20)
